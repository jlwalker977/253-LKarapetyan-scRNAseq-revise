...
```{r}
dat_tmde1c = qread("dat-tmde1-clean4-removed-clus-6-9.qs")
#TIL claude fix 4
#TIL LOOP SETUP
...
cell.types <- unique(dat_tmde1c@meta.data$gen_cell_types2)
##TIL LOOP SETUP 2
...
time.sub <- subset(dat_tmde1c, subset = timepoint == time)
}
