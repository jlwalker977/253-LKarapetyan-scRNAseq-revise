...
csv_folder <- "DEG_contrasts_PBMC_MAST_v7/filtered_csv"
...
extract_contrast_annotation <- function(contrast_names, cat) {
  ...
  # ── Timepoint: EXCLUDED from timepoint plot, kept for treatment & PFS ─────
  if (cat != "Timepoint") {
  ...
  } else if (cat == "Timepoint") {
    # Timepoint annotation removed — only show Treatment arm and CellType
