...
out.dir <- file.path(results, "scDblFinder_tmp_sl")
dir.create(out.dir, recursive = TRUE, showWarnings = FALSE)

for (nm in sample_names) {
  out.file <- file.path(out.dir, paste0(nm, "_singlets_sl.qs"))
...
saved.files <- file.path(out.dir, paste0(sample_names, "_singlets_sl.qs"))
...
qsave(dat_tc4_clean,
      file = "dat-til-redo-scdblfinder-doublets-removed-pre-normd-042426-slurm.qs")
cat("Successfully completed! Hooray!")
